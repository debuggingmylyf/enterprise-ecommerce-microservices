...
import com.ecommerce.product.dto.common.ApiErrorResponse;
import com.ecommerce.product.dto.common.FieldErrorResponse;
...
/**
 * Centralized exception handler for all controllers in the Product Service.
 *
 * <p>Maps domain exceptions to structured {@link ApiErrorResponse} payloads and
 * appropriate HTTP status codes, ensuring consistent error contracts for API consumers.
 */
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles {@link ResourceNotFoundException} thrown when a Product or Category
    ...
    /**
     * Handles {@link BusinessException} thrown when a domain business rule is violated
     * (e.g. duplicate SKU, invalid price range).
     *
     ...
     * Collects per-field violation messages into a list of {@link FieldErrorResponse}.
     *
    ...
    /**
     * Handles database unique-constraint violations surfaced as
     * {@link DataIntegrityViolationException} by Spring Data JPA.
     *
